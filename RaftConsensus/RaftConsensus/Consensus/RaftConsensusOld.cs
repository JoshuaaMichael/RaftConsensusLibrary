...
{
    public class RaftConsensusOld<TKey, TValue> : IConsensus<TKey, TValue> where TKey : ICloneable where TValue : ICloneable
    {
        ...
        public RaftConsensusOld(string nodeName, int listeningPort)
        {
